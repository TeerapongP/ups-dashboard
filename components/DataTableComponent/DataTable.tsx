...
export default function DataTable({ upsData }: DataTableProps) {
  ...
  const headers = loggedIn
    ? [
      'ID', 'Status', 'IP Address', 'Brand', 'Model', 'Location', 'Battery (%)', 'Battery (VDC)',
      'Backup Time (MIN)', 'Temp (°C)', 'Input L1(V)', 'Input L2(V)', 'Input L3(V)',
      'Input L1(A)', 'Input L2(A)', 'Input L3(A)', 'Input Frequency(Hz)',
      'Output L1(V)', 'Output L2(V)', 'Output L3(V)', 'Output L1(A)', 'Output L2(A)',
      'Output L3(A)', 'Output Frequency(Hz)', 'Load (VA)', 'Load (W)', 'Input Max', 'Input Min',
    ]
    : [
